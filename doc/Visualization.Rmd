...
1. [Generate a Heatmap Plot](#heatmap)
2. [Create an Enhanced Dimensional Reduction Plot](#dimplot)
3. [Create an Enhanced Violin Plot](#vlnplot)
4. [Visualize Cluster Distribution in Samples](#barplot)
5. [Generate a Waterfall Plot](#waterfall)
6. [Explore Color Functions](#color)

## Generate a Heatmap Plot {#heatmap}
...
## Create an Enhanced Dimensional Reduction Plot {#dimplot}
...
For each variable, you can specify custom colors, adjust themes, and more. For detailed information on color customization, refer to the [Explore Color Functions](#color) section:
...
## Create an Enhanced Violin Plot {#vlnplot}
...
## Visualize Cluster Distribution in Samples {#barplot}
...
## Generate a Waterfall Plot {#waterfall}

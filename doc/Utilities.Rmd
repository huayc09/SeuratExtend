...
1. [Facilitate Gene Naming Conversions](#name_conversion)
2. [Compute Statistics Grouped by Clusters](#calcstats)
3. [Assess Proportion of Positive Cells in Clusters](#feature_percent)
4. [Run Standard Seurat Pipeline](#run_seurat)

## Facilitate Gene Naming Conversions {#name_conversion}
...
## Compute Statistics Grouped by Clusters {#calcstats}
...
## Assess Proportion of Positive Cells in Clusters {#feature_percent}
...
## Run Standard Seurat Pipeline {#run_seurat}

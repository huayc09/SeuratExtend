...
1. [Importing SCENIC Loom Files into Seurat](#import-scenic)
2. [Visualizing SCENIC Results](#visualize-scenic) 

## Importing SCENIC Loom Files into Seurat {#import-scenic}
...
## Visualizing SCENIC Results {#visualize-scenic}

Once SCENIC data is integrated into a Seurat object, users can leverage a variety of visualization tools provided in the [Enhanced Visualization](#enhanced-visualization) section to explore and interpret these regulatory networks. Both the extracted `tf_auc` matrix or the Seurat object itself can be used as inputs. Here are some practical examples:
